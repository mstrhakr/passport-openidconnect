...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    // Condensed parameter contruction
    ['prompt','display','ui_Locales','login_Hint','max_Age','acr_Values','id_Token_Hint'].forEach((property)=>{
      var [property] = options[property.toLowerCase] || this['_' + property.split('_').join('')];
      if (property) { params[property.toLowerCase()] = [property]; }
    })
    /*
